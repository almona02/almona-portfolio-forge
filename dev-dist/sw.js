...
define([],(function () { 'use strict';
    ...
    */
    ...
    registerRoute(/\.(?:png|jpg|jpeg|webp|svg|gif)$/, new CacheFirst({
    ...
    registerRoute(/^https:\/\/.*\.supabase\.co\/.*/i, new NetworkFirst({
    ...
    registerRoute(/\.(?:js|css|woff2?)$/, new StaleWhileRevalidate({
