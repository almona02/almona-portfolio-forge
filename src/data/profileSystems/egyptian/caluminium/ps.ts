...
export const CALUMINIUM_PS_PACK: SystemPack = {
  ...
  // Complete profiles array for cut list generation with accurate dimensions
  profiles: [
    // PS 6600 Sliding Frame
    {
      id: 'PS-6601-FRAME',
      name: 'PS 6600 Frame Profile',
      type: 'frame',
      material: 'aluminum',
      width: 97.15,
      height: 66,
      ...
      minStockLevel: 0,
      supplier: 'CALUMINIUM',
      systemBrand: 'CALUMINIUM',
      profileRole: 'frame',
      weightPerMeter: 0.900,
      systemType: 'sliding',
      specifications: {
        profile_number: 'PS-6601',
        system_name: 'PS 6600 Sliding',
    ...
    // PS 9600 Sliding Frame
    {
      id: 'PS-9601-FRAME',
      name: 'PS 9600 Frame Profile',
      type: 'frame',
      material: 'aluminum',
      width: 97.15,
      height: 115.6,
    ...
    // PS 5600 Hinged Frame
    {
      id: 'PS-5600-FRAME',
      name: 'PS 5600 Frame Profile',
      type: 'frame',
      material: 'aluminum',
      width: 85.0,
      height: 72.0,
    ...
    // PS 4800 Hinged Frame
    {
      id: 'PS-4800-FRAME',
      name: 'PS 4800 Frame Profile',
      type: 'frame',
      material: 'aluminum',
      width: 78.5,
      height: 78.5,
    ...
    // PS 100 Curtain Wall Mullion
    {
      id: 'PS-101-MULLION',
      name: 'PS 100 Mullion Profile',
      type: 'mullion',
      material: 'aluminum',
      width: 54,
      height: 100,
      ...
      systemBrand: 'CALUMINIUM',
      profileRole: 'mullion',
      weightPerMeter: 2.859,
      systemType: 'curtain_wall',
      specifications: {
        profile_number: 'PS-101',
        system_name: 'PS 100 Curtain Wall',
        moment_of_inertia_cm4: 252.5,
