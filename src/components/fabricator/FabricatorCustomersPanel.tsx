      ...
      <Card className="bg-gray-900/80 border-gray-800">
        <CardHeader>
          ...
          <CardDescription className="text-xs text-gray-400">
            Per-workshop customer directory used by the New Project Wizard. Create a customer once,
            then reuse it from the dropdown when starting new projects.
          </CardDescription>
        </CardHeader>
      ...
      <Card className="bg-gray-900/80 border-gray-800">
        <CardHeader className="pb-3 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
          ...
          <CardDescription className="text-[11px] text-gray-400">
            These customers are available in the New Project Wizard dropdown.
          </CardDescription>
        </CardHeader>
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex justify-end mb-2">
                ...
                >
                  New Order for selected customer
                </Button>
              </div>
