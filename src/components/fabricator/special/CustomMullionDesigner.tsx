            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-gray-300">Window Width (mm)</Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-2">
                  <Label className="text-gray-300">Window Height (mm)</Label>
                  <Input
                    type="number"
              ...
              {/* Mullion Type */}
              <div className="space-y-2">
                <Label className="text-gray-300">Mullion Type</Label>
                <Select
                  value={mullionType}
                    ...
                    <div>
                      ...
                      <div className="bg-gray-800/50 p-3 rounded space-y-2 text-sm">
                        ...
                        <div className="flex justify-between border-t border-gray-700 pt-2">
                          ...
                          <span className="text-orange-400 font-semibold">{validation.cost.totalCost.toFixed(2)} EGP</span>
                        </div>
                      </div>
                    </div>
