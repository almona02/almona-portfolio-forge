...
const PasswordInput = React.forwardRef<HTMLInputElement, GoldTierInputProps>(
  ({ className, type: _type = "password", showPasswordToggle = true, variant, size, fullWidth, ...props }, ref) => {
...
const SearchInput = React.forwardRef<HTMLInputElement, GoldTierInputProps>(
  ({ className, clearable = true, onChange, value, variant, size, fullWidth, ...props }, ref) => {
    const handleClear = () => {
      if (onChange) {
        const event = {
          target: { value: "" },
...
const Input = React.forwardRef<HTMLInputElement, GoldTierInputProps>(
  ({
    className,
    variant,
    size,
    ...
    // Generate unique ID for accessibility - always call useId unconditionally
...
Input.displayName = "GoldTierInput";

export { Input as GoldTierInput, inputVariants, PasswordInput, SearchInput };
export type { GoldTierInputProps };
