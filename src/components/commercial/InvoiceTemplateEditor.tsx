 ...
 * 
 * Commercial Page Enhancement - Invoice Template Creation/Editing
 * Create and edit invoice document templates with layout configuration.
 * 
...
import {
    ...
    type InvoiceTemplateCreateRequest,
    type InvoiceTemplateUpdateRequest,
} from '@/services/invoiceTemplatesApi';

/**
 * Template configuration structure (same as quote templates)
 */
...
export const InvoiceTemplateEditor: React.FC<InvoiceTemplateEditorProps> = ({
    ...
    const [category, setCategory] = useState<InvoiceTemplateCategory>('custom');
        ...
        const loadTemplate = async () => {
            ...
            try {
                ...
                if (template.template_config && typeof template.template_config === 'object') {
                    setConfig(template.template_config as InvoiceTemplateConfig);
                }
            } catch (error) {
                toast.error(
    ...
    const handleSave = useCallback(async () => {
        ...
        setIsSaving(true);
        try {
            const request: InvoiceTemplateCreateRequest | InvoiceTemplateUpdateRequest = {
                name: name.trim(),
            ...
            let result: InvoiceTemplateResponse;
            if (templateId) {
                result = await updateInvoiceTemplate(templateId, request);
                toast.success('Template updated successfully');
            } else {
                result = await createInvoiceTemplate(request);
    ...
    return (
        <Card className={cn(className)}>
            <CardHeader>
                ...
                <CardDescription>
                    Configure the layout and styling for invoice documents
                </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <Select
                                    value={category}
                                    onValueChange={(value) => setCategory(value as InvoiceTemplateCategory)}
                                >
