...
import { MachineRegistrationEnhanced as MachineRegistration } from "./MachineRegistration";
...
import { OperatorTrainingIncentiveDialog } from "./OperatorTrainingIncentiveDialog";
...
const Services = () => {
  ...
  console.log("Training dialog open state:", trainingDialogOpen);
            ...
            <TabsContent value="overview">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <ServiceCard
                  ...
                  onActionClick={handleTrainingClick}
                />
              </div>
