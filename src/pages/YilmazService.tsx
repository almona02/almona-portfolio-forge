      ...
      <main className="pt-24 pb-16 bg-gray-50 dark:bg-gray-950 min-h-screen">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h1 className="typography-h1 mb-4">Yilmaz Service Center Egypt</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white dark: bg-gray-900 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 card-dark">
              <Wrench className="w-12 h-12 text-blue-600 mb-6" />
              <h3 className="typography-h3 mb-4">Technical Support & Repair</h3>
              ...
              <ul className="space-y-2 mb-6 text-sm text-gray-500 dark:text-gray-400">
                <li className="flex items-center"><ShieldCheck className="w-4 h-4 mr-2  status-valid" /> 24/7 Emergency Response</li>
                <li className="flex items-center"><ShieldCheck className="w-4 h-4 mr-2  status-valid" /> Remote Diagnostics</li>
                <li className="flex items-center"><ShieldCheck className="w-4 h-4 mr-2  status-valid" /> On-site Repair</li>
              </ul>
            ...
            <div className="bg-white dark: bg-gray-900 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 card-dark">
              ...
              <h3 className="typography-h3 mb-4">Preventive Maintenance</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
               ...
               <ul className="space-y-2 mb-6 text-sm text-gray-500 dark:text-gray-400">
                <li className="flex items-center"><ShieldCheck className="w-4 h-4 mr-2  status-valid" /> Annual Service Contracts</li>
                <li className="flex items-center"><ShieldCheck className="w-4 h-4 mr-2  status-valid" /> Calibration Services</li>
                <li className="flex items-center"><ShieldCheck className="w-4 h-4 mr-2  status-valid" /> Performance Reports</li>
              </ul>
              <Link to="/contact">
          ...
          <div className="bg-blue-600 text-white rounded-xl p-8 flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              <h3 className="typography-h3 mb-2">Need Spare Parts?</h3>
