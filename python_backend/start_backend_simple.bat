@echo off
REM Simple backend startup for DXF import testing (no Celery/Redis needed)
REM This is sufficient for testing DXF direct import
...
REM Set environment variable (optional, but good practice)
