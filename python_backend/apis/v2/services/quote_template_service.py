...
from apis.v2.repositories.quote_templates_repository import (
...
class QuoteTemplateService:
    """Service layer for quote templates."""

    def __init__(self, supabase: Client):
        self._repo = QuoteTemplatesRepository(supabase)
        self._db = supabase

    def _convert_db_row_to_response(
        self, row: Dict[str, Any]
    ) -> QuoteTemplateResponse:
        """Convert database row to QuoteTemplateResponse model."""
    ...
    def list_templates(
        ...
        try:
            ...
            raise SupabaseError(
                message="Failed to list quote templates",
    ...
    ) -> Optional[QuoteTemplateResponse]:
        """Get template by ID."""
        try:
            ...
            raise SupabaseError(
                message="Failed to retrieve quote template",
    ...
    def delete_template(
        ...
        """Delete quote template (soft delete)."""
        try:
